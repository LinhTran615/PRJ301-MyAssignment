...
<style>
  /* hero */
  .home-hero{background:linear-gradient(135deg,#e7f1ff,#f6f9ff);border:1px solid #e5e7eb;border-radius:14px;padding:18px;margin-bottom:16px}
  ...
  .btn{background:#3b82f6;color:#fff;text-decoration:none;border-radius:8px;padding:10px 14px;display:inline-block;font-weight:600;border:1px solid transparent}
